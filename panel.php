		...
		<div class="row">
			<div class="col-6">
				...
				<div class="form-group">
					...
					<input required type="text" name="nombre" class="form-control" value="<?php
                      if(isset($_SESSION['idUsuario'])) {
                ...
                <div class="form-group">
                <p style="font-size:20px"> Apellido </p>
                   
					<input required type="text" name="apellido" class="form-control" value="<?php
                ...
                <p style="font-size:20px"> dirección </p>
					...
					<input  required type="text" id="p1" name="direccion" class="form-control" value="<?php
            ...
            <div class="col-6 ">
                <div class="container border border-warning">
                    <div class="row">
                        <div class="col-12">
                            <img src="<?php echo $_SESSION['avatar'];?>" alt="" class="rounded-circle" style="height: 25vh;margin-left:200px">
                        </div>
